...
function LoginForm() {
  ...
  return <div className="auth-card auth-login-card">
    ...
    {import.meta.env.VITE_GOOGLE_CLIENT_ID && <div className="google-auth"><span>أو</span><div className="google-login-shell"><span><FaGoogle />Login with Google</span><GoogleLogin onSuccess={signInWithGoogle} onError={() => toast.error("تعذر الاتصال بـ Google.")} text="signin_with" theme="outline" shape="pill" size="large" width="300" /></div></div>}
